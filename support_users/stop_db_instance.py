  ...
  if region != 'us-gov-west-1' and region != 'me-south-1' and region != 'ap-east-1':
      try:
        ...
        for resp in response['DBInstances']:
            if resp['DBInstanceStatus'] == "available":
...
if instance_found == 'True':
    ...
    instance_region = raw_input('Enter region of the instance to stop...:')
    instanceid = raw_input('Enter ID of the instance to stop...:')
    ...
    print("No started instances found")
